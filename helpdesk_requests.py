...
import requests
from Query_Date import current_time
...
def helpdesk_new_ticket(message, user_guid, outlet_code):
    ...
    myobj = {
            'assigned_to': '',
            'user_guid': user_guid, #"DD58AC07CB1D11EAB573DED0BD1483FD", #'5583163CC7E811E993063CA0676091C4',
            'status_guid': '1',
            'priority_guid': '3',
            'department_guid': '1',
            ...
            'internal_note': '',
            'alertuser': '',
            'staff_guid': 'DD58AC07CB1D11EAB573DED0BD1483FD'
            }
